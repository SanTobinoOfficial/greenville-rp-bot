  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#2B2D31]">
      <div className="bg-[#1E2124] rounded-2xl p-8 w-full max-w-sm shadow-2xl border border-white/10">
        ...
        {error && (
          <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-3 mb-6 text-red-300 text-sm text-center">
            Błąd logowania. Sprawdź czy masz dostęp do serwera.
          </div>
        )}
