...
export async function PATCH(req: NextRequest) {
  ...
  if (body.rules_channel_id             !== undefined) allowed.rules_channel_id             = body.rules_channel_id;
  if (body.public_updates_channel_id    !== undefined) allowed.public_updates_channel_id    = body.public_updates_channel_id;
  if (body.explicit_content_filter      !== undefined) allowed.explicit_content_filter      = body.explicit_content_filter;
